...
//        recyclerView.setItemViewCacheSize(33);
    ...
    private List<BaseViewItem> buildItems() {
        ...
        items.add(mockNewFeedItem(null, getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), null, getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
...
//        items.add(null);
        ...
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
//        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), null, getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
//        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), null));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        ...
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), null));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
        items.add(mockNewFeedItem(getRandomName(), getRandomTime(), getRandomMessage(), getRandomUrl()));
